...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-winter-gold text-winter-midnight hover:bg-white hover:shadow-lg hover:-translate-y-1",
        secondary:
          "bg-transparent text-white border-2 border-white/50 hover:bg-white/10 hover:border-white",
        outline:
          "border-2 border-winter-twilight text-winter-twilight hover:bg-winter-twilight hover:text-white",
